<template>
  <AdminLayout title="Specializations">
    <div class="p-8">
      ...
      <div class="mb-4 flex items-center space-x-3">
        ...
        <select v-model="sortBy" class="border px-3 py-1 rounded">
          <option value="specialization_id">ID</option>
          <option value="specialization_name">Name</option>
        </select>
      ...
      >
        ...
        <tbody>
          <tr
            v-for="specialization in sortedSpecializations"
          ...
          >
            ...
            <td class="border px-4 py-2">
              <span
                :class="specialization.specialization_status === 1
                  ? 'text-green-600'
                  : 'text-red-500'"
              >
                {{
                  specialization.specialization_status === 1
                    ? 'Active'
                    : 'Inactive'
                }}
              </span>
...
const sortBy = ref('specialization_id')
const sortDirection = ref('asc')

const sortedSpecializations = computed(() => {
  return [...props.specializations].sort((a, b) => {
